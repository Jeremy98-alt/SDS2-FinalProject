...
model2 <- function(){
  ...
  for (i in 1:N){
    y[i] ~ dbern(p[i])
    cloglog(p[i]) <-  beta1*x1[i]^2 + beta2*x2[i] + beta3*x3[i] + beta4*x4[i]^2 + beta5*x5[i]^3 + beta6*x6[i] + beta7*x7[i] + beta8*x8[i] + beta9*x9[i] + beta10*x10[i] + beta11*x11[i] + beta12*x12[i]^3 + beta13*x13[i] # omit intercept and not useful variables
  }
